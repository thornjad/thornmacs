...
int fget_internal_border_width(const struct frame *f);
Lisp_Object fget_minibuffer_window(const struct frame *f);
Lisp_Object fget_root_window(const struct frame *f);
struct terminal * fget_terminal(const struct frame *f);
